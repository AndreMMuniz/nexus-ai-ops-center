import { Play, MoreHorizontal, Database, CloudOff, Cloud, StopCircle } from "lucide-react";
                ...
                <div className="p-4 space-y-4 flex-1">
                    ...
                    <div className="bg-black/40 border border-emerald-900/30 rounded-lg p-4 relative overflow-hidden group hover:border-[#00DC82]/50 transition-colors">
                        ...
                        <div className="flex justify-between items-center mb-2 relative z-10">
                            ...
                            <button className="flex items-center gap-1 px-2 py-1 rounded border border-red-500/30 text-red-400 bg-red-500/10 hover:bg-red-500/20 text-xs transition-colors">
                    ...
                    {/* FastAPI Backend */}
                    <div className="bg-black/40 border border-[#1F2937] rounded-lg p-4 relative overflow-hidden group hover:border-gray-600 transition-colors">
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-gray-600"></div>
                        <div className="flex justify-between items-center mb-2 relative z-10">
                            <div className="flex items-center gap-3">
                                <div className="p-1.5 rounded bg-gray-700/50 text-gray-300">
                                    <CloudOff className="w-5 h-5" />
                                </div>
                                <span className="font-medium text-sm text-gray-200">FastAPI Backend</span>
                            </div>
                            <button className="flex items-center gap-1 px-2 py-1 rounded border border-gray-600 text-gray-300 hover:bg-white/5 text-xs transition-colors">
